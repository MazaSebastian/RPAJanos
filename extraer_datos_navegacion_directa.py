...
# -*- coding: utf-8 -*-
"""
Script para capturar la URL del enlace dentro del iframe y navegar directamente a la página del evento
"""
...
def extraer_datos_navegacion_directa():
    """Capturar URL del enlace dentro del iframe y navegar directamente a la página del evento"""
    
    print("=== EXTRACCIÓN DE DATOS CON NAVEGACIÓN DIRECTA ===")
    print("Proceso:")
    print("1. Acceder al calendario")
    print("2. Capturar URL del enlace dentro del iframe")
    print("3. Navegar directamente a la página del evento")
...
if __name__ == "__main__":
    resultado = extraer_datos_navegacion_directa()
    if resultado:
        print(f"\n=== RESULTADO FINAL ===")
