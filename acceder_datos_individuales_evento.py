...
# -*- coding: utf-8 -*-
"""
Script para hacer clic en el enlace del evento y acceder a los datos individuales
"""
...
def acceder_datos_individuales_evento():
    """Hacer clic en el enlace del evento y acceder a los datos individuales"""
    
    print("=== ACCESO A DATOS INDIVIDUALES DEL EVENTO ===")
    print("Objetivo: Hacer clic en el enlace 33069 y extraer datos específicos")
    ...
    try:
        ...
        # PASO 9: HACER CLIC EN ENLACE DEL EVENTO
        print(f"\n=== PASO 9: HACER CLIC EN ENLACE DEL EVENTO ===")
...
if __name__ == "__main__":
    resultado = acceder_datos_individuales_evento()
    if resultado:
        print(f"\n=== RESULTADO FINAL ===")
