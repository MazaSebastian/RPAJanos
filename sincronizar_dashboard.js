// Script para sincronizar el dashboard con el API
console.log('🔄 Sincronizando dashboard con API...');
...
fetch('http://localhost:3002/api/coordinations')
  ...
  .then(data => {
    console.log(`📊 API tiene ${data.data.length} coordinaciones`);
    ...
    console.log('📊 Primeras 5 coordinaciones:', coordinaciones.slice(0, 5));
